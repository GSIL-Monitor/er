...
<div id="reset-content">
	...
	<div class="ret-login-form">
		<div class="cell ret-cell ret-pwd-cell"><input class="text" type="text" id="password" name="password" maxlength="30" placeholder="新密码"/></div>
		<div class="cell ret-cell ret-pwd-cell"><input class="text" type="text" id="repassword" name="repassword" maxlength="30" placeholder="确认新密码"/></div>
		<div class="cell2 ret-cell ret-pwd-cell"><a id="submit" href="<?php echo U('Home/Login/reset_pwd_success');?>" class="button">完成</a></div>
	</div>
</div>
