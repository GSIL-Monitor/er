<?php
require_once(ROOT_DIR . '/Adapter/OuterUtils.php');
...
class WmsAdapter
{
    ...
    function __construct($wms_type,$wms_info)
    {
        ...
        switch($wms_type)
        {
            ...
            case 11://奇门
            {
            	require_once(ROOT_DIR . '/modules/adapter/wms_qm.php');
	...
	public function getTransferFlag($wms_type, $wms_info_type, $method, &$error_info,$api_url='')
	{
