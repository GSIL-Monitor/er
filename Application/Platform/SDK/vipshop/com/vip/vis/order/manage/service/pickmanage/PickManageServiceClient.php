...
class PickManageServiceClient{
	...
	public static function getService(){
		...
		if (! PickManageServiceClient::$isRegis){
			
			PickManageServiceClient::regis ();
			PickManageServiceClient::$isRegis = true;
		}
		
		
		$ctx = \Osp\Context\InvocationContextFactory::getInstance ();
		$ip = PickManageServiceClient::$DEFAULT_PROXY_IP;
		$port = PickManageServiceClient::$DEFAULT_PROXY_PORT;	
		try{
		...
		return new \com\vip\vis\order\manage\service\pickmanage\PickManageServiceHelper();
	}
