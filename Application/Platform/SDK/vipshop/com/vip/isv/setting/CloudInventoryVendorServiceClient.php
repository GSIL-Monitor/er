...
class CloudInventoryVendorServiceClient{
	...
	public static function getService(){
		...
		if (! CloudInventoryVendorServiceClient::$isRegis){
			
			CloudInventoryVendorServiceClient::regis ();
			CloudInventoryVendorServiceClient::$isRegis = true;
		}
		
		
		$ctx = \Osp\Context\InvocationContextFactory::getInstance ();
		$ip = CloudInventoryVendorServiceClient::$DEFAULT_PROXY_IP;
		$port = CloudInventoryVendorServiceClient::$DEFAULT_PROXY_PORT;	
		try{
		...
		return new \com\vip\isv\setting\CloudInventoryVendorServiceHelper();
	}
