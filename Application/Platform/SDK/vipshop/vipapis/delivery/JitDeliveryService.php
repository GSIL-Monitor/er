...
class _JitDeliveryServiceClient extends \Osp\Base\OspStub implements \vipapis\delivery\JitDeliveryServiceIf{
	...
	public function createPick( $po_no, $vendor_id, $co_mode, $warehouse, $store_sn = null){
	...
	public function getPoList( $st_create_time, $et_create_time, $warehouse, $po_no, $co_mode, $vendor_id, $st_sell_st_time, $et_sell_st_time, $st_sell_et_time, $et_sell_et_time, $page, $limit, $st_po_start_time = null, $et_po_start_time = null){
	...
	public function getPoOrders( $warehouse, $po_no, $co_mode, $vendor_id, $st_sell_st_time, $et_sell_st_time, $page, $limit, $st_po_start_time = null, $et_po_start_time = null){
