...
class ccbClient{
    ...
    function encrypt($params){
        $aes = new ccbAes2();
        return $aes->encrypt($params,$this->key);
    }
    ...
    function decrypt($params){
        ...
        return $aes->decrypt($tt);*/
        
        $aes = new ccbAes2();
        return $aes->decrypt($params,$this->key);
    }
