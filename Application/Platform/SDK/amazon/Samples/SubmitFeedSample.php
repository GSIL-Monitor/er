...
define('TOP_SDK_DIR', 'E:/workspace/EShopMaster/EShopServer/cron/sync/api/');
...
$feed = sprintf($feed, MERCHANT_ID, '1234567789', $date, '快递', '2345678901');
...
/**
  ...
  */
  function invokeSubmitFeed(MarketplaceWebServiceOrders_Interface $service, $request) 
  {
      try {
