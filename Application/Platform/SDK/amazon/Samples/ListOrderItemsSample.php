...
define('TOP_SDK_DIR', 'C:/AppServ/www/v2/sync/api/');

include_once (TOP_SDK_DIR . '/amazon/Client.php');
include_once (TOP_SDK_DIR . '/amazon/Model/MarketplaceIdList.php');

include_once (TOP_SDK_DIR . '/amazon/Model/ListOrdersRequest.php');
include_once (TOP_SDK_DIR . '/amazon/Model/ListOrdersResponse.php');
include_once (TOP_SDK_DIR . '/amazon/Model/ListOrdersResult.php');


include_once (TOP_SDK_DIR . '/amazon/Model/ListOrderItemsRequest.php');
include_once (TOP_SDK_DIR . '/amazon/Model/ListOrderItemsResponse.php');
include_once (TOP_SDK_DIR . '/amazon/Model/ListOrderItemsResult.php');
 ...
 ***********************************************************************/
 ...
 $request->setAmazonOrderId('C02-4762050-9353641');
