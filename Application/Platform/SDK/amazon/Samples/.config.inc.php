<?php
    ...
    * http://aws.amazon.com
    ***********************************************************************/
    define('AWS_ACCESS_KEY_ID', 'AKIAIRUAPC5DR2JUEIDA');
    define('AWS_SECRET_ACCESS_KEY', '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');  
    ...
    ***********************************************************************/
    define('APPLICATION_NAME', 'WangdianTong');
    ...
    * marketplace ID.
    ***********************************************************************/
    define ('MERCHANT_ID', 'AR2OJ8UGEF07Y');
