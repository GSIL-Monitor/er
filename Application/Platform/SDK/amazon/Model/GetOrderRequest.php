...
class MarketplaceWebServiceOrders_Model_GetOrderRequest_Aux extends MarketplaceWebServiceOrders_Model
{
	private $ids;
...
class MarketplaceWebServiceOrders_Model_GetOrderRequest extends MarketplaceWebServiceOrders_Model
{
    ...
    {
        $aux = new MarketplaceWebServiceOrders_Model_GetOrderRequest_Aux();
		$aux->setId($value);
		$this->_fields['AmazonOrderId']['FieldValue'] = $aux;
        return;
    }
