...
class JdClient
{
	...
	public function execute($request, $access_token = null)
	{
		...
		$sysParams["method"] = method_exists($request,'getApiMethodName')?$request->getApiMethodName():$request->getApiMethod();
		...
		//获取业务参数
		$apiParams = method_exists($request,'getApiParas')?$request->getApiParas():$request->getAppJsonParams();
