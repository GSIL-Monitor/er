...
use Platform\Wms\Pheanstalk_Command_AbstractCommand;
use Platform\Wms\Pheanstalk_ResponseParser;
require_once(ROOT_DIR . '/Wms/AbstractCommand.php');
require_once(ROOT_DIR . '/Wms/ResponseParser.php');
/**
 * The 'watch' command.
