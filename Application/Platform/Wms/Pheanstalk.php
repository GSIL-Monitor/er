...
use Platform\Wms\Pheanstalk_Response;
use Platform\Wms\Pheanstalk_Command_WatchCommand;
require_once(ROOT_DIR . '/Wms/Connection.php');
require_once(ROOT_DIR . '/Wms/Response.php');
require_once(ROOT_DIR . '/Wms/WatchCommand.php');
/**
...
class Pheanstalk
{
	...
	public function reserve($timeout = null)
	{
		...
		{
			return new Pheanstalk_Job($response['id'], $response['jobdata']); //, $response['tube']
		}
	}
