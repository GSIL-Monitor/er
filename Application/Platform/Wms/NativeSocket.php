...
use Platform\Wms\Pheanstalk_Socket;
use Platform\Wms\Pheanstalk_Exception_ConnectionException;
use Platform\Wms\Pheanstalk_Socket_StreamFunctions;
require_once(ROOT_DIR . '/Wms/StreamFunctions.php');
require_once(ROOT_DIR . '/Wms/ConnectionException.php');
require_once(ROOT_DIR . '/Wms/Socket.php');
/**
